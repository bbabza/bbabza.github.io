...
(function () {
  ...
  (function initAdmin() {
    ...
    function exportCSV(rows) {
      var headers = ['Ref No', 'Name', 'Enrollment No', 'Bar Association', 'Mobile', 'Email', 'Events', 'Partner Name', 'Partner Enrollment', 'Partner Bar Association', 'Total Amount', 'UTR No', 'Payment Status'];
