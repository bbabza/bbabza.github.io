...
serve(async (req: Request) => {
  ...
  if (operation === 'update_member') {
    ...
    const allowed = ['name', 'cc_no', 'practice_area', 'enrolled_year', 'status', 'mobile', 'address', 'description', 'is_bar_council_member', 'is_office_bearer', 'office_bearer_position', 'gender', 'membership_type', 'yearly_renewed_date', 'res_phone', 'office_phone', 'is_admin'];
